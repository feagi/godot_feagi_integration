...
@export var use_bang_bang_instead_of_actual_value: bool = true ## If set, any nonzero input will be treated as full firing. Otherwise will pass the actual float value to the input event
