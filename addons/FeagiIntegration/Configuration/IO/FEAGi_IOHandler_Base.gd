...
var _cached_bytes: PackedByteArray = [] ## The latest cached data, either generated by [FEAGI_IOHandler_Sensory_Base] on its "refresh_cached_sensory" call, or pass to 
