...
@export_enum("camera", "motion_control", "accelerometer", "gyro", "proxmity") var initial_device_type_of_agent: String ## The type of this device. Note this can be overridden from the setup function
