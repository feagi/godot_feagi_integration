...
func sensor_register(device_type_name: StringName, device_name: StringName, data_retrieval_function: Callable) -> FEAGI_IOHandler_Sensory_Base:
	...
	if key not in sensors:
		...
		return null
	var sensor_definition: FEAGI_IOHandler_Sensory_Base = sensors[key]
...
func sensor_deregister(device_type_name: StringName, device_name: StringName) -> FEAGI_IOHandler_Sensory_Base:
	if device_type_name not in allowed_sensor_device_types:
