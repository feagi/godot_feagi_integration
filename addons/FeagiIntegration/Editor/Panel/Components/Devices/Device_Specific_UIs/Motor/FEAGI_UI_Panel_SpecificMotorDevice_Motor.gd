...
var _emuInput_settings: Editor_FEAGI_UI_Panel_EmuInputConfigurations
...
func setup() -> void:
	...
	_emuInput_settings = $CollapsiblePrefab/PanelContainer/MarginContainer/Internals/Editor_FEAGI_UI_Panel_EmuInputConfigurations
