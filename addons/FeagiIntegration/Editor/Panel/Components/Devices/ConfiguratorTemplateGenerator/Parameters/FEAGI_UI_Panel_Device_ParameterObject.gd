@tool
extends FEAGI_UI_Panel_Device_ParameterBase
class_name FEAGI_UI_Panel_Device_ParameterObject

var _internals: Array[FEAGI_UI_Panel_Device_ParameterBase] = []
...
func setup_internals(internals: Array[FEAGI_UI_Panel_Device_ParameterBase]) -> void:
