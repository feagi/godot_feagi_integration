...
var _sensors: Array[FEAGI_Device_Sensor_Base] = []
var _cached_sensor_sending_data: Array[PackedByteArray] = []
var _motors: Array[FEAGI_Device_Motor_Base] = []
...
func alert_debugger_about_sensor_creation(FEAGI_sensor: FEAGI_Device_Sensor_Base) -> void:
...
func alert_debugger_about_motor_creation(FEAGI_motor: FEAGI_Device_Motor_Base) -> void:
...
func _add_sensor(FEAGI_sensor: FEAGI_Device_Sensor_Base) -> void:
	_sensors.append(FEAGI_sensor)
	_cached_sensor_sending_data.append(FEAGI_sensor.get_cached_data_as_byte_array())

func _remove_sensor(FEAGI_sensor: FEAGI_Device_Base) -> void:
...
func _add_motor(FEAGI_motor: FEAGI_Device_Motor_Base) -> void:
	_motors.append(FEAGI_motor)
	_cached_motor_sending_data.append(FEAGI_motor.get_cached_data_as_byte_array())

func _remove_motor(FEAGI_motor: FEAGI_Device_Motor_Base) -> void:
